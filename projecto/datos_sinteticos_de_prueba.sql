...
-- Ejecutar DESPUÉS de cargar los datos sintéticos
-- =====================================================
...
(
    ...
    crypt('almirantesenior', gen_salt('bf')),
    0.00
),
(
    'panxocloloco',
    'panxocloloco@demo.cl',
    crypt('panxoxo', gen_salt('bf')),
    25.50
),
(
    'chuckmcgill',
    'chuckmcgill@demo.cl',
    crypt('estadisticopesao', gen_salt('bf')),
    500.00
);
...
-- chuckmcgill:
-- todos los logros de los juegos que posee
